  ...
  return (
    ...
    >
      ...
      <Text variant="description">
        ...
        stuff, anything is cool. So feel free to message me on an{' '}
        <Link
          href="mailto:bmars8218@gmail.com"
          target="_blank"
          rel="noreferrer"
        >
          email
      ...
      >
        <Link
          ...
          textDecoration="none"
          rel="noreferrer"
          href="https://github.com/Brunom8218/LM_portfolio"
          target="_blank"
        ...
        >
          <Text as="span">
            ...
            LM Lionel <Icon as={RiCopyleftLine} /> {`${year}`}
          </Text>
        </Link>
      </Box>
    </Stack>
